...
namespace PinturilloSO
{
    public partial class CambiarPerfil: Form
    {
        ...
        public CambiarPerfil(MenuJugador.Jugador PerfilJugador, Socket Servidor = null)
        {
            ...
            this.AcceptButton = BotonConfirmar;
            this.FraseFavorita = PerfilJugador.FraseFavorita;
        ...
        private void CambiarPerfil_Load(object sender, EventArgs e)
        {
        ...
        private void BotonGuardar_Click(object sender, EventArgs e)
        {
            ...
            FraseFavorita = FraseLabel.Text;

            string mensaje = "1/2/" + NuevoUsuario + "/" + CodigoFotoPerfil + "/" + Usuario + "/" +  FraseFavorita;
        ...
        private void FraseCambiar_Click(object sender, EventArgs e)
        {
            if (FraseBox.Text == "")
            {
                MessageBox.Show("No ha introducido ningun nombre.");
